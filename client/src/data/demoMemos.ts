const demoMemos = [
...

  {
    ...
    content:
      '=> the web-based notes app built for your essential daily needs, combining simplicity, accessibility and minimalism with `Markdown syntax`, **rich text functionality** and *extended customisability*',
    dateCreated: Date.now(),
    author: { username: 'memoify', name: 'Memoify', id: '' },
    id: 'demoMemoId' + Date.now() + Math.floor(Math.random() * 9999)
  }
